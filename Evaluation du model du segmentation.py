...
class MaskRCNNConfig:
    IMAGE_SIZE = (640, 480)
    VAL_ANNOTATIONS = 'train_mask_rcnn1/annotations/validation'
    VAL_IMAGES = 'train_mask_rcnn1/images/validation'
...
def evaluate_model(model_path='bird_segmentation_best.keras'):
...
if __name__ == "__main__":
    model_path = 'bird_segmentation_best.keras'
